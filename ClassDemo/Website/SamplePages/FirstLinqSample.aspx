...
<asp:Label ID="Label1" runat="server" Text="Select an Artist"></asp:Label>
    ...
    <br />
    <asp:GridView ID="ArtistAlbumList" runat="server" AutoGenerateColumns="False" DataSourceID="ArtistAlbumListODS" AllowPaging="True" AllowSorting="true">
        <Columns>
